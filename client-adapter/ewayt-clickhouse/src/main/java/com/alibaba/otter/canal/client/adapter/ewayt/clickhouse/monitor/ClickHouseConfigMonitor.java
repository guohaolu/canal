package com.alibaba.otter.canal.client.adapter.ewayt.clickhouse.monitor;
...
public class ClickHouseConfigMonitor {
    ...
    private static final String   adapterName = "ewayt-clickhouse";

    private String                key;

    private EwaytClickHouseAdapter ewaytClickHouseAdapter;

    private Properties            envProperties;

    private FileAlterationMonitor fileMonitor;

    public void init(String key, EwaytClickHouseAdapter ewaytClickHouseAdapter, Properties envProperties) {
        this.key = key;
        this.ewaytClickHouseAdapter = ewaytClickHouseAdapter;
    ...
    private class FileListener extends FileAlterationListenerAdaptor {
        ...
        public void onFileCreate(File file) {
            ...
            try {
                ...
                config.validate();
                boolean result = ewaytClickHouseAdapter.addConfig(file.getName(), config);
                if (result) {
        ...
        public void onFileChange(File file) {
            ...
            try {
                if (ewaytClickHouseAdapter.getClickHouseMapping().containsKey(file.getName())) {
                    // 加载配置文件
                    ...
                    config.validate();
                    ewaytClickHouseAdapter.updateConfig(file.getName(), config);
        ...
        public void onFileDelete(File file) {
            ...
            try {
                if (ewaytClickHouseAdapter.getClickHouseMapping().containsKey(file.getName())) {
                    ewaytClickHouseAdapter.deleteConfig(file.getName());
