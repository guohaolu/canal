package com.alibaba.otter.canal.client.adapter.ewayt.clickhouse.config;
...
public class ConfigLoader {
    ...
    public static Map<String, MappingConfig> load(Properties envProperties) {
        ...
        Map<String, String> configContentMap = MappingConfigsLoader.loadConfigs("ewayt-clickhouse");
